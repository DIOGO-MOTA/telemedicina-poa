...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text42', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#icons01', { style: 'fade-up', speed: 625, intensity: 4, threshold: 3, delay: 125, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('#text24', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#image18', { style: 'fade-in', speed: 125, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 9, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('#text05', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons05', { style: 'fade-down', speed: 750, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('#text20', { style: 'fade-in', speed: 1000, intensity: 9, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('#text30', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons04', { style: 'fade-down', speed: 750, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('#image13', { style: 'flip-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons06', { style: 'fade-down', speed: 750, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-in', speed: 1000, intensity: 9, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('#text14', { style: 'fade-in', speed: 1000, intensity: 9, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('h1.style9, h2.style9, h3.style9, p.style9', { style: 'fade-in', speed: 1000, intensity: 9, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('h1.style11, h2.style11, h3.style11, p.style11', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 625, intensity: 4, threshold: 3, delay: 125, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
